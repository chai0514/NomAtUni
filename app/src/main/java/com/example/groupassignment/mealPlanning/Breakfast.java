...
public class Breakfast extends AppCompatActivity implements Bridge{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SearchView searchView = findViewById(R.id.sc_searchBf);
        ...
        bt_cancel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent cancel = new Intent(Breakfast.this, calorie_tracker.class);
        ...
        new FetchNutrientsTask() {
            ...
            protected void onPostExecute(List<String> result) {
                if (result != null) {
                    ...
                    new AlertDialog.Builder(Breakfast.this)
                            .setTitle("Add to Breakfast")
                            .setMessage("Are you sure you want to add " + food + " to breakfast?")
                            .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    try {
                                        ...
                                        jsonObject.put("meal_type", "Breakfast");
                                        ...
                                        NomSupabase.storeData thread = new NomSupabase.storeData(food, "Breakfast", calories,context ,handler);
                                        thread.start(); // Start the thread

                                    } catch (JSONException e) {
                                        throw new RuntimeException(e);
                                    }
                                    Intent start_calorie = new Intent(Breakfast.this, calorie_tracker.class);
                    ...
                    Toast.makeText(Breakfast.this, "Error fetching data", Toast.LENGTH_SHORT).show();
                }
            }
        }.execute(fdcId);
    }
