...
public class Dinner extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SearchView searchView = findViewById(R.id.sc_searchD);
        ...
        bt_cancel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent cancel = new Intent(Dinner.this, calorie_tracker.class);
        ...
        new Breakfast.FetchNutrientsTask() {
            ...
            protected void onPostExecute(List<String> result) {
                if (result != null) {
                    ...
                    new AlertDialog.Builder(Dinner.this)
                            .setTitle("Add to Dinner")
                            .setMessage("Are you sure you want to add " + food + " to Dinner?")
                            .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    try {
                                        ...
                                        jsonObject.put("meal_type", "Dinner");
                                        ...
                                        NomSupabase.storeData thread = new NomSupabase.storeData(food, "Dinner", calories, context, handler);
                                        thread.start(); // Start the thread

                                    } catch (JSONException e) {
                                        throw new RuntimeException(e);
                                    }
                                    Intent start_calorie = new Intent(Dinner.this, calorie_tracker.class);
                    ...
                    Toast.makeText(Dinner.this, "Error fetching data", Toast.LENGTH_SHORT).show();
                }
            }
        }.execute(fdcId);
    }
